...
| `error-model.md`           | How-to for the kit's typed-error contract: per-BC leaves vs use-case composites, `#[serde(tag = "code")]` wire shape, Tauri command boundary, FE handling, anti-patterns (complements `ddd-reference.md` § Errors) |
