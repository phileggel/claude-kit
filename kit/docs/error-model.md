...
| Layering rules within a BC (domain / service) | [`ddd-reference.md`](ddd-reference.md) § Errors |
| Backend coding rules (B31 in particular)      | [`backend-rules.md`](backend-rules.md)          |
